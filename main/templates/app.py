# -*- coding: utf-8 -*-
"""Copia de MEDIMPAPP: innovación energética.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1sT4PEGG-5qLL_lNS5vtD_35qiADuZWBG

##MEDIMPAPP: Proyecto de software para medir posible impacto de políticas de innovación en energía

Predictor MEDIMPAPP

Predicción y comparación de "data_value" para **2022** con árbol de desición regresor
"""
...
# Realizar la predicción para el año 2022 utilizando el modelo cargado
valor_prediccion_2022 = np.array([[2022]])
prediccion_2022 = modelo_cargado.predict(valor_prediccion_2022)
...
# Calcular el coeficiente de determinación (R2 score) utilizando el modelo original
